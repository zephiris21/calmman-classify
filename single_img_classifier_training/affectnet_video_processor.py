...
from affectnet_classifier import TorchFacialClassifier
...
class TorchVideoProcessor:
    ...
    def __init__(self, config_path: str = "config/config_affectnet.yaml"):
        """
        비디오 프로세서 초기화
...
def main():
    ...
    parser.add_argument('--config', default='config/config_affectnet.yaml', help='설정 파일 경로')
